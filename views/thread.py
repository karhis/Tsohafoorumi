...
def threadpage(thread_id):
    ...
    return render_template("thread.html", title=title, locked=title[1], messages=replys, thread_id=thread_id, subforum_name=subforum_info[0], forum_name=forum_name, forum_id=subforum_info[1], subforum_id=title[2])
